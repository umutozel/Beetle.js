...
declare module beetle {
	...
	namespace interfaces {
		...
		interface TrackableArray<T> extends Array<T> {
			...
			load(expands: string[], resourceName: string, options: ManagerQueryOptions,
				successCallback?: (items: T[]) => void, errorCallback?: (e: Error) => void): AjaxCall<interfaces.QueryResultArray<T>>;
		}
		...
		interface ClosedQueryable<T, TOptions> {
			execute(options?: TOptions, successCallback?: (result: T) => void, errorCallback?: (e: Error) => void): AjaxCall<T>;
			execute<TResult>(options?: TOptions, successCallback?: (result: TResult) => void, errorCallback?: (e: Error) => void): AjaxCall<TResult>;
			x(options?: TOptions, successCallback?: (result: T) => void, errorCallback?: (e: Error) => void): AjaxCall<T>;
			x<TResult>(options?: TOptions, successCallback?: (result: TResult) => void, errorCallback?: (e: Error) => void): AjaxCall<TResult>;
			then(successCallback: (result: T) => void, errorCallback?: (e: Error) => void, options?: TOptions): AjaxCall<T>;
		}
		...
		interface Tracker {
			...
			loadNavigationProperty(navPropName: string, expands: string[], resourceName: string, options?: ManagerQueryOptions,
				successCallback?: (result: any) => void, errorCallback?: (e: Error) => void): AjaxCall<any>;
	...
	namespace querying {
		...
		class EntityQuery<T> implements interfaces.Query<T> {
			...
			execute(options?: ManagerQueryOptions, successCallback?: (result: interfaces.QueryResultArray<T>) => void, errorCallback?: (e: Error) => void): AjaxCall<interfaces.QueryResultArray<T>>;
			execute<TResult>(options?: ManagerQueryOptions, successCallback?: (result: TResult) => void, errorCallback?: (e: Error) => void): AjaxCall<TResult[]>;
			x(options?: ManagerQueryOptions, successCallback?: (result: interfaces.QueryResultArray<T>) => void, errorCallback?: (e: Error) => void): AjaxCall<interfaces.QueryResultArray<T>>;
			x<TResult>(options?: ManagerQueryOptions, successCallback?: (result: TResult) => void, errorCallback?: (e: Error) => void): AjaxCall<TResult[]>;
	...
	namespace core {
		...
		class EntityManager {
			...
			createEntityAsync<T extends IEntity>(type: string | (new() => T), initialValues?: Object, options?: ManagerQueryOptions,
				successCallback?: (entity: T) => void, errorCallback?: (e: Error) => void): AjaxCall<T>;
			createEntityAsync(typeName: string, initialValues?: Object, options?: ManagerQueryOptions,
				successCallback?: (entity: IEntity) => void, errorCallback?: (e: Error) => void): AjaxCall<IEntity>;
			...
			createRawEntityAsync<T extends IEntity>(type: string | (new() => T), initialValues?: Object, options?: ManagerQueryOptions,
				successCallback?: (rawEntity: interfaces.RawEntity) => void, errorCallback?: (e: Error) => void): AjaxCall<interfaces.RawEntity>;
			createRawEntityAsync(typeName: string, initialValues?: Object, options?: ManagerQueryOptions,
				successCallback?: (rawEntity: interfaces.RawEntity) => void, errorCallback?: (e: Error) => void): AjaxCall<interfaces.RawEntity>;
			executeQuery<T>(query: querying.EntityQuery<T>, options?: ManagerQueryOptions, successCallback?: (result: T[]) => void, errorCallback?: (e: Error) => void): AjaxCall<T[]>;
			executeQuery<T>(query: interfaces.ClosedQueryable<T, ManagerQueryOptions>, options?: ManagerQueryOptions, successCallback?: (result: T) => void, errorCallback?: (e: Error) => void): AjaxCall<T>;
			executeQuery(query: querying.EntityQuery<any>, options?: ManagerQueryOptions, successCallback?: (result: any) => void, errorCallback?: (e: Error) => void): AjaxCall<any>;
			executeQuery(query: interfaces.ClosedQueryable<any, ManagerQueryOptions>, options?: ManagerQueryOptions, successCallback?: (result: any) => void, errorCallback?: (e: Error) => void): AjaxCall<any>;
			...
			hasChanges(): boolean;
			getChanges(): IEntity[];
			saveChanges(options?: ManagerSaveOptions, successCallback?: (result: interfaces.SaveResult) => void, errorCallback?: (e: Error) => void): AjaxCall<interfaces.SaveResult>;
			savePackage(savePackage: interfaces.SavePackage, options?: PackageSaveOptions, successCallback?: (result: interfaces.SaveResult) => void, errorCallback?: (e: Error) => void): AjaxCall<interfaces.SaveResult>;
